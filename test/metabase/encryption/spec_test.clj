...
(deftest spec-covers-all-encrypted-models-test
  (testing "The encryption spec should contain entries for all models with encrypted columns"
    (is (contains? encryption-spec/encryption-spec :model/Database))
    (is (contains? encryption-spec/encryption-spec :model/User))
    (is (contains? encryption-spec/encryption-spec :model/Channel))
    (is (contains? encryption-spec/encryption-spec :model/Setting))
    (is (contains? encryption-spec/encryption-spec :model/Secret))
    (is (contains? encryption-spec/encryption-spec :model/Workspace))))
